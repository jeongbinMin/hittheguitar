...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action:none only while actively reframing (dragging to
    // reposition) — scoping it to data-reframe keeps normal page scroll
    // working when a visitor's touch starts on a photo.
